...
#define RES_FONT_TRANSCRIPT  CINDER_RESOURCE( ../resources/font, transcript_bold.otf, 128, FONT )
#define RES_FONT_APERCU_MONO CINDER_RESOURCE( ../resources/font, Apercu_Mono.otf, 129, FONT )

#define RES_TEXTURE_2x2    CINDER_RESOURCE( ../resources/texture, test_texture_2x2.png, 130, DATA )
#define RES_TEXTURE_NOISE  CINDER_RESOURCE( ../resources/texture, noise.png, 131, DATA )
#define RES_TEXTURE_RANDOM CINDER_RESOURCE( ../resources/texture, random.png, 132, DATA )
...
#define RES_GLSL_PASS_THRU CINDER_RESOURCE( ../resources/glsl/, pass_thru.glsl, 131, GLSL )

#define RES_GLSL_NORMAL_VERT CINDER_RESOURCE( ../resources/glsl/material/, normal_vert.glsl, 132, GLSL )
#define RES_GLSL_NORMAL_FRAG CINDER_RESOURCE( ../resources/glsl/material/, normal_frag.glsl, 133, GLSL )

/*--------------------------------------------------------------------------------------------*/
// glsl bg
/*--------------------------------------------------------------------------------------------*/

#define RES_GLSL_BG_GRADIENT_FRAG CINDER_RESOURCE( ../resources/glsl/bg/, bg_gradient_frag.glsl, 134, GLSL )
#define RES_GLSL_BG_MESH_VERT     CINDER_RESOURCE( ../resources/glsl/bg/, bg_mesh_vert.glsl,     135, GLSL )
#define RES_GLSL_BG_MESH_FRAG     CINDER_RESOURCE( ../resources/glsl/bg/, bg_mesh_frag.glsl,     136, GLSL )
#define RES_GLSL_BG_MIX_FRAG      CINDER_RESOURCE( ../resources/glsl/bg/, bg_mix_frag.glsl,      137, GLSL )

/*--------------------------------------------------------------------------------------------*/
// glsl quote
/*--------------------------------------------------------------------------------------------*/

#define RES_GLSL_BOARD_QUOTE_FIELD_VERT CINDER_RESOURCE( ../resources/glsl/material/, quote_field_vert.glsl, 138, GLSL )
#define RES_GLSL_BOARD_QUOTE_FIELD_FRAG CINDER_RESOURCE( ../resources/glsl/material/, quote_field_frag.glsl, 139, GLSL )

/*--------------------------------------------------------------------------------------------*/
// glsl fx
/*--------------------------------------------------------------------------------------------*/

#define RES_GLSL_WORLD_FX_NORMAL_DEPTH_VERT CINDER_RESOURCE( ../resources/glsl/fx, normal_depth_vert.glsl, 140, GLSL )
#define RES_GLSL_WORLD_FX_NORMAL_DEPTH_FRAG CINDER_RESOURCE( ../resources/glsl/fx, normal_depth_frag.glsl, 141, GLSL )
#define RES_GLSL_WORLD_FX_SSAO_VERT         CINDER_RESOURCE( ../resources/glsl/fx, ssao_vert.glsl, 142, GLSL )
#define RES_GLSL_WORLD_FX_SSAO_FRAG         CINDER_RESOURCE( ../resources/glsl/fx, ssao_frag.glsl, 143, GLSL )
#define RES_GLSL_WORLD_FX_BLUR_VERT         CINDER_RESOURCE( ../resources/glsl/fx, blur_vert.glsl, 144, GLSL )
#define RES_GLSL_WORLD_FX_BLUR_H_FRAG       CINDER_RESOURCE( ../resources/glsl/fx, blur_h_frag.glsl, 145, GLSL )
#define RES_GLSL_WORLD_FX_BLUR_V_FRAG       CINDER_RESOURCE( ../resources/glsl/fx, blur_v_frag.glsl, 147, GLSL )
