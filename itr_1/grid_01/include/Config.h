...
#define QUOTE_FIELD_NUM_DIVERS_MIN 10//30//10
#define QUOTE_FIELD_NUM_DIVERS_MAX 20//70//50
...
#define QUOTE_FIELD_DIVER_MIN_OFFSET 1.0f//-1.0f
#define QUOTE_FIELD_DIVER_MAX_OFFSET 1.0f//-0.8f
#define QUOTE_FIELD_DIVER_MIN_SPEED  0.0f//0.0115f
#define QUOTE_FIELD_DIVER_MAX_SPEED  0.0f//0.0125f
