...
class Stage {
    ...
    void drawExportLayoutArea(const LayoutArea& area);
    void drawExportViewports();
...
public:
    ...
    inline void releaseTheDingo(){
        mThemeView->releaseTheDingo();
    }
