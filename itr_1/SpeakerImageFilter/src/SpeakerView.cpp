...
static const float cubeHeight_2 = 0.025f;
...
SpeakerView::SpeakerView(Speaker* data) :
    ...
    mSize(3,3){
        ...
        mShaderBlurHRef = FxShader::GetBlurH();
        mShaderBlurVRef = FxShader::GetBlurV();
...
void SpeakerView::draw(){
    ...
    drawFocus(sin(app::getElapsedSeconds()) * 0.5f + 0.5f);
  ...
  //  glColorPointer(3, GL_FLOAT, 0, &sCardNormals[0]);
