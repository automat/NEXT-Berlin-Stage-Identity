...
gl::GlslProgRef FxShader::sShaderBlurH;
gl::GlslProgRef FxShader::sShaderBlurV;

gl::GlslProgRef FxShader::GetBlurH(){
...
gl::GlslProgRef FxShader::GetBlurV(){
