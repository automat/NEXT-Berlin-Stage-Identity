...
#define QUOTE_FIELD_NUM_DIVERS_MAX 10//50
#define QUOTE_FIELD_SURFACE_PATH_DENSITY 0.75f
#define QUOTE_FIELD_SURFACE_PATH_OFFSET_SPEED 0.0f//   0.0075f
#define QUOTE_FIELD_SURFACE_PATH_AMPLITUDE 0.0f// 0.55f//0.25f//0.125f//0.325f


#define QUOTE_FIELD_DIVER_NUM_POINTS 10//20 //10
#define QUOTE_FIELD_DIVER_MIN_HEIGHT 0.015f
#define QUOTE_FIELD_DIVER_MAX_HEIGHT 0.065f
#define QUOTE_FIELD_DIVER_MIN_OFFSET 1.0f//-1.0f//-0.9f//1.0f
#define QUOTE_FIELD_DIVER_MAX_OFFSET 1.0f//-0.8f//-1.0f
#define QUOTE_FIELD_DIVER_MIN_SPEED  0.0f//0.0135f//0.01f//0.0025f
#define QUOTE_FIELD_DIVER_MAX_SPEED  0.0f//0.015f//0.01f//0.0045f
