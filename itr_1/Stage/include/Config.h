...
#define SESSION_VIEW_SLIDE_LENGTH 6.5f
#define SESSION_VIEW_SLIDE_SCREEN_CENTER_OFFSET 0.5f

#define SESSION_EVENT_ANIM_IN_OUT   2.0f//1.35f
#define SESSION_EVENT_ANIM_TIME_OFF 3.0f
#define SESSION_EVENT_ANUM_TIME_ON  4.0f

#define SESSION_EVENT_TIME_MAX 2.0f    //10
#define SESSION_EVENT_TIME_SPEAKER_MIN 1.0f  //3

#define SESSION_VIEW_SPEAKER_SIZE ci::Vec2f(1.5f,0.025f)
...
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_DELAY_STEP_MIN 2.0f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_DELAY_STEP_MAX 2.5f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_TIME_MIN 6.0f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_TIME_MAX 8.0f

#define THEME_FIELD_QUOTE_MANAGER_ANUM_OUT_TO_MIN 3.0f
#define THEME_FIELD_QUOTE_MANAGER_ANUM_OUT_TO_MAX 3.25f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_OUT_DELAY_STEP_MIN 0.5f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_OUT_DELAY_STEP_MAX 1.0f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_OUT_TIME_MIN 5.0f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_OUT_TIME_MAX 6.0f
...
#define QUOTE_FIELD_NUM_DIVERS_MIN 10//10//10//10
#define QUOTE_FIELD_NUM_DIVERS_MAX 50//50//50//50
...
#define QUOTE_FIELD_DIVER_MAX_OFFSET_X -0.8f
