...
#define SESSION_VIEW_SPEAKER_SIZE ci::Vec2f(1.25f,0.025f)
...
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_DELAY_STEP_MIN 0.5f//2.0f//2.0f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_DELAY_STEP_MAX 1.0f//2.5f//2.5f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_TIME_MIN  6.00f//6.0f//6.0f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_IN_TIME_MAX  8.00f//8.0f//8.0f

#define THEME_FIELD_QUOTE_MANAGER_ANUM_OUT_TO_MIN 3.0f
#define THEME_FIELD_QUOTE_MANAGER_ANUM_OUT_TO_MAX 3.25f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_OUT_DELAY_STEP_MIN 0.6f//0.5f
#define THEME_FIELD_QUOTE_MANAGER_ANIM_OUT_DELAY_STEP_MAX 1.0f//1.0f
...
#define QUOTE_FIELD_DIVER_MAX_OFFSET_X  -0.9f
