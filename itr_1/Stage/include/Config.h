...
#define TWITTER_LOGO_SIZE 120
#define TWITTER_LOGO_MARGIN_LEFT 100
#define TWITTER_LOGO_MARGIN_BOTTOM 100 - TWITTER_LOGO_SIZE
...
#define SESSION_LABEL_SESSION_TITLE_UNDERLINE_COLOR  ci::Color::hex(0x00030D)
