...
#define SESSION_EVENT_TIME_MAX 10.0f
#define SESSION_EVENT_TIME_SPEAKER_MIN 3.0f
...
#define SESSION_LABEL_TITLE_SHADOW_STRENGTH 0.15f
...
#define SESSION_LABEL_SESSION_TITLE_SHADOW_COLOR     ci::ColorAf(0,0,0,0.125f)
