...
#define SESSION_VIEW_SPEAKER_SIZE ci::Vec2f(0.95f,0.025f)
...
#define SESSION_LABEL_EVENT_TITLE_SHADOW_COLOR       ci::ColorAf(0,0,0,0.15f)
...
#define SESSION_LABEL_SPEAKER_FONT_SIZE SESSION_LABEL_TITLE_FONT_SIZE
#define SESSION_LABEL_SPEAKER_FONT_SCALE 6
#define SESSION_LABEL_SPEAKER_LINE_HEIGHT 1.125f
