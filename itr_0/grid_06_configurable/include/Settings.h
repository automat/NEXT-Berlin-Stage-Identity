...
extern int /*#define*/ CELL_MIN_NUM_DIVERS; /* 5 */
extern int /*#define*/ CELL_MAX_NUM_DIVERS; /* 50 */
extern float /*#define*/ CELL_OFFSET_SPEED; /* 0.01f*/
#define CELL_DIVER_NUM_POINTS 10
extern float /*#define*/ CELL_DIVER_MIN_HEIGHT; /* 0.01f */
extern float /*#define*/ CELL_DIVER_MAX_HEIGHT; /*0.085f*///0.05f

#define PATH_NUM_POINTS 20

extern float /*#define*/ DIVER_MIN_OFFSET;// 1
extern float /*#define*/ DIVER_MAX_OFFSET;;// 1//0.5f
extern float /*#define*/ DIVER_MIN_SPEED;//  0//0.02f
extern float /*#define*/ DIVER_MAX_SPEED;//  0.01f//0.03f
extern float /*#define*/ DIVER_MIN_LENGTH;// 1.0f//0.5f
extern float /*#define*/ DIVER_MAX_LENGTH;// 1.0f
