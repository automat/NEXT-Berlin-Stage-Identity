...
static const string FILE_TO_WATCH("program_frag.glsl");
static const string PATH_TO_WATCH("/Users/automat/Projects/next/tests/GPGPUTest02/resources/" + FILE_TO_WATCH);

static const int   APP_WINDOW_WIDTH(1024),APP_WINDOW_HEIGHT(512);
static const float APP_FPS(30.0f);

class GPGPUTest02App : public AppNative {
public:
...
void GPGPUTest02App::updateFileWatcher(){
...
void GPGPUTest02App::initShaders(){
    this->loadShader(mOutShader, loadResource("out_vert.glsl"),      loadResource("out_frag.glsl"));
    this->loadShader(mPosShader, loadResource("passthru_vert.glsl"), loadResource(FILE_TO_WATCH));
}

void GPGPUTest02App::loadShader(gl::GlslProg &prog, DataSourceRef refVertGLSL, DataSourceRef refFragGLSL){
    try{
...
void GPGPUTest02App::setupFboPositionInitial(){
...
void GPGPUTest02App::applyInitialTexToFbo(Surface32f &surface, gl::Fbo &fbo){
...
void GPGPUTest02App::updatePositionFbo(){
...
void GPGPUTest02App::retrieveFboData(){
...
CINDER_APP_NATIVE( GPGPUTest02App, RendererGl )
